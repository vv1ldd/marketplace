@php
    $copy = [
        'title' => __('storefront.index.title'),
        'eyebrow' => __('storefront.index.eyebrow'),
        'hero_title' => __('storefront.index.hero_title'),
        'hero_lead' => __('storefront.index.hero_lead'),
        'search_label' => __('storefront.index.search_label'),
        'search_button' => __('storefront.index.search_button'),
        'search_note' => __('storefront.index.search_note'),
        'suggestions_label' => __('storefront.index.suggestions_label'),
        'proofs' => [
            ['title' => __('storefront.index.proof_instant_title'), 'text' => __('storefront.index.proof_instant_text')],
            ['title' => __('storefront.index.proof_guarantee_title'), 'text' => __('storefront.index.proof_guarantee_text')],
            ['title' => __('storefront.index.proof_support_title'), 'text' => __('storefront.index.proof_support_text')],
        ],
        'stats' => [
            'total' => __('storefront.index.stats_total'),
            'provider' => __('storefront.index.stats_provider'),
            'offers' => __('storefront.index.stats_offers'),
            'public' => __('storefront.index.stats_public'),
            'review' => __('storefront.index.stats_review'),
        ],
        'groups_title' => __('storefront.index.groups_title'),
        'groups_subtitle' => __('storefront.index.groups_subtitle'),
        'all_catalog' => __('storefront.index.all_catalog'),
        'variants' => __('storefront.index.variants'),
        'regions' => __('storefront.index.regions'),
        'nominals' => __('storefront.index.nominals'),
        'groups_empty' => __('storefront.index.groups_empty'),
        'featured_title' => __('storefront.index.featured_title'),
        'featured_subtitle' => __('storefront.index.featured_subtitle'),
        'all_categories' => __('storefront.index.all_categories'),
        'topup' => __('storefront.index.topup'),
        'available' => __('storefront.index.available'),
        'open' => __('storefront.index.open'),
        'featured_empty' => __('storefront.index.featured_empty'),
        'coming_title' => __('storefront.index.coming_title'),
        'coming_partner_subtitle' => __('storefront.index.coming_partner_subtitle'),
        'coming_public_subtitle' => __('storefront.index.coming_public_subtitle'),
        'connect_seller' => __('storefront.index.connect_seller'),
        'coming_status' => __('storefront.index.coming_status'),
        'connect' => __('storefront.index.connect'),
        'network_partner_summary' => __('storefront.index.network_partner_summary'),
        'network_public_summary' => __('storefront.index.network_public_summary'),
        'network_empty' => __('storefront.index.network_empty'),
        'brands_title' => __('storefront.index.brands_title'),
        'brands_subtitle' => __('storefront.index.brands_subtitle'),
        'products' => __('storefront.index.products'),
        'in_stock' => __('storefront.index.in_stock'),
        'brands_empty' => __('storefront.index.brands_empty'),
        'categories_title' => __('storefront.index.categories_title'),
        'categories_subtitle' => __('storefront.index.categories_subtitle'),
        'with_offers' => __('storefront.index.with_offers'),
        'categories_empty' => __('storefront.index.categories_empty'),
        'ai_subtitle' => __('storefront.index.ai_subtitle'),
        'ai_close' => __('storefront.index.ai_close'),
        'ai_greeting' => __('storefront.index.ai_greeting'),
        'ai_help' => __('storefront.index.ai_help'),
        'ai_input' => __('storefront.index.ai_input'),
        'ai_send' => __('storefront.index.ai_send'),
        'suggest_soon' => __('storefront.index.suggest_soon'),
        'suggest_min' => __('storefront.index.suggest_min'),
        'suggest_loading' => __('storefront.index.suggest_loading'),
        'suggest_found_prefix' => __('storefront.index.suggest_found_prefix'),
        'suggest_found_suffix' => __('storefront.index.suggest_found_suffix'),
        'suggest_empty' => __('storefront.index.suggest_empty'),
        'suggest_error' => __('storefront.index.suggest_error'),
        'ai_unexpected_error' => __('storefront.index.ai_unexpected_error'),
        'ai_network_error' => __('storefront.index.ai_network_error'),
        'chips' => ['steam' => __('storefront.index.chip_steam'), 'spotify' => __('storefront.index.chip_spotify')],
    ];
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="{{ __('storefront.index.meta_description') }}">
