<x-filament-panels::page>
    <div class="space-y-6 max-w-5xl mx-auto">
        {{-- Верхняя секция: Детали тикета (горизонтально или компактно) --}}
        <div class="w-full">
            {{ $this->infolist->getComponent('details') }}
        </div>

        {{-- Нижняя секция: Переписка и форма ответа --}}
        <div class="space-y-6">
            {{-- История сообщений --}}
            {{ $this->infolist->getComponent('messages') }}
