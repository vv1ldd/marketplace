...
class ProviderCatalogPayloadNormalizer
{
    ...
    public function normalizeCatalogItem(array $item): array
    {
        ...
        $title = trim((string) ($item['name'] ?? $item['title'] ?? 'Provider Catalog Item'));
    ...
    public function normalizeRetailerItem(array $item): array
    {
        ...
        $title = trim((string) ($product['title'] ?? $product['name'] ?? $item['product_name'] ?? $item['name'] ?? 'Provider Retailer Item'));
