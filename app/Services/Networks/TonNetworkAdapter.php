...
class TonNetworkAdapter implements SettlementNetworkAdapter
{
    ...
    public function walletPreview(array $identity, ?User $user = null): array
    {
        ...
        $coins = [[
            ...
            'note' => $adapterEnabled
                ? $network->label.' balance is observed from chain when the API is available.'
        ...
        foreach ($network->assets as $asset) {
            ...
            $coins[] = [
                ...
                'status' => $adapterEnabled ? 'balance_unavailable' : 'coming_soon',
                'note' => $adapterEnabled
                    ? $network->label.' jetton balances will appear here once observation is enabled.'
                    : $network->label.' jetton support is being wired into the shared settlement layer.',
            ];
        }
        ...
        return [
            ...
            'contract' => [
                ...
                'dto_boundary' => $adapterEnabled ? 'settlement_adapter' : 'ton_adapter_pending',
            ],
            'wallet' => [
