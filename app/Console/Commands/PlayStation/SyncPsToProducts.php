    ...
    public function handle()
    {
        ...
        foreach ($items as $item) {
            ...
            $products[] = [
                ...
                'name' => $item->name,
                'type' => 'playstation',
                'category' => 'game', // Default for PlayStation items
                'price_rub' => $price_rub,
                'base_price' => $base_price_rub, // Store calculated base price too
                'purchase_price' => $item->price_with_discount, // In TRY (raw cents)
        ...
        Product::upsert(
            $products,
            ['sku'],
            ['name', 'price_rub', 'base_price', 'purchase_price', 'purchase_currency', 'data', 'is_active', 'updated_at']
        );
