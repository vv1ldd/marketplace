...
**turnover_summary** | [**\AppYandexSdk\Model\TurnoverDTO**](TurnoverDTO.md) |  | [optional]
**stocks** | [**\AppYandexSdk\Model\WarehouseStockDTO[]**](WarehouseStockDTO.md) | Информация об остатках. |
