 ...
 */
class GetCampaignOfferDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        ...
        'campaign_price' => '\AppYandexSdk\Model\GetPriceWithVatDTO',
        'status' => '\AppYandexSdk\Model\OfferCampaignStatusType',
     ...
     * Gets campaign_price
     *
     * @return \AppYandexSdk\Model\GetPriceWithVatDTO|null
     */
     ...
     * Sets campaign_price
     *
     * @param  \AppYandexSdk\Model\GetPriceWithVatDTO|null  $campaign_price  campaign_price
     * @return self
     */
     ...
     * Gets status
     *
     * @return \AppYandexSdk\Model\OfferCampaignStatusType|null
     */
     ...
     * Sets status
     *
     * @param  \AppYandexSdk\Model\OfferCampaignStatusType|null  $status  status
     * @return self
     */
     ...
     * Sets errors
     *
     * @param  \AppYandexSdk\Model\OfferErrorDTO[]|null  $errors  Ошибки, препятствующие размещению товара на витрине.
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param  \AppYandexSdk\Model\OfferErrorDTO[]|null  $warnings  Предупреждения, не препятствующие размещению товара на витрине.
     * @return self
     */
