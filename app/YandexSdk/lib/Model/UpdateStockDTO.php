 ...
 */
class UpdateStockDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'sku' => 'string',
        'items' => '\AppYandexSdk\Model\UpdateStockItemDTO[]',
    ];
     ...
     * Gets items
     *
     * @return \AppYandexSdk\Model\UpdateStockItemDTO[]
     */
     ...
     * Sets items
     *
     * @param  \AppYandexSdk\Model\UpdateStockItemDTO[]  $items  Информация об остатках товара.
     * @return self
     */
