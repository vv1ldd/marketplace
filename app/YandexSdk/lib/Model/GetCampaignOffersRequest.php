 ...
 */
class GetCampaignOffersRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'offer_ids' => 'string[]',
        'statuses' => '\AppYandexSdk\Model\OfferCampaignStatusType[]',
        'category_ids' => 'int[]',
        'vendor_names' => 'string[]',
        'tags' => 'string[]',
    ];
     ...
     * Sets statuses
     *
     * @param  \AppYandexSdk\Model\OfferCampaignStatusType[]|null  $statuses  Фильтр по статусам товаров.
     * @return self
     */
