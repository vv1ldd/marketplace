 ...
 */
class QuarantineOfferDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'current_price' => '\AppYandexSdk\Model\BasePriceDTO',
        'last_valid_price' => '\AppYandexSdk\Model\BasePriceDTO',
        'verdicts' => '\AppYandexSdk\Model\PriceQuarantineVerdictDTO[]',
    ];
     ...
     * Sets current_price
     *
     * @param  \AppYandexSdk\Model\BasePriceDTO|null  $current_price  current_price
     * @return self
     */
     ...
     *
     * @param  \AppYandexSdk\Model\BasePriceDTO|null  $last_valid_price  last_valid_price
     * @return self
     */
     ...
     * Gets verdicts
     *
     * @return \AppYandexSdk\Model\PriceQuarantineVerdictDTO[]|null
     */
     ...
     * Sets verdicts
     *
     * @param  \AppYandexSdk\Model\PriceQuarantineVerdictDTO[]|null  $verdicts  Причины попадания товара в карантин.
     * @return self
     */
