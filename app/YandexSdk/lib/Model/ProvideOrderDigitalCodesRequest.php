 ...
 */
class ProvideOrderDigitalCodesRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'items' => '\AppYandexSdk\Model\OrderDigitalItemDTO[]',
    ];
     ...
     * Gets items
     *
     * @return \AppYandexSdk\Model\OrderDigitalItemDTO[]
     */
     ...
     * Sets items
     *
     * @param  \AppYandexSdk\Model\OrderDigitalItemDTO[]  $items  Список проданных товаров.  Для товара с одинаковым `id` передавайте один элемент и массив `codes` по количеству ключей.
     * @return self
     */
