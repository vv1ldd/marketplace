 ...
 */
class UpdatePromoOffersRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'promo_id' => 'string',
        'offers' => '\AppYandexSdk\Model\UpdatePromoOfferDTO[]',
    ];
     ...
     * Gets offers
     *
     * @return \AppYandexSdk\Model\UpdatePromoOfferDTO[]
     */
     ...
     * Sets offers
     *
     * @param  \AppYandexSdk\Model\UpdatePromoOfferDTO[]  $offers  Товары, которые необходимо добавить в акцию или цены которых нужно изменить.
     * @return self
     */
