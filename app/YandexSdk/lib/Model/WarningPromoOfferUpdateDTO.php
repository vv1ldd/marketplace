 ...
 */
class WarningPromoOfferUpdateDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'warnings' => '\AppYandexSdk\Model\PromoOfferUpdateWarningDTO[]',
    ];
     ...
     * Gets warnings
     *
     * @return \AppYandexSdk\Model\PromoOfferUpdateWarningDTO[]
     */
     ...
     * Sets warnings
     *
     * @param  \AppYandexSdk\Model\PromoOfferUpdateWarningDTO[]  $warnings  Предупреждения, которые появились при добавлении товара в акцию или изменении его цен.
     * @return self
     */
