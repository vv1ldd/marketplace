 ...
 */
class CategoryDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'children' => '\AppYandexSdk\Model\CategoryDTO[]',
    ];
     ...
     * Sets children
     *
     * @param  \AppYandexSdk\Model\CategoryDTO[]|null  $children  Дочерние категории.
     * @return self
     */
