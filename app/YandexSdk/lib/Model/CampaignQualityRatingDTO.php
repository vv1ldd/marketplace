 ...
 */
class CampaignQualityRatingDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'campaign_id' => 'int',
        'ratings' => '\AppYandexSdk\Model\QualityRatingDTO[]',
    ];
     ...
     * Gets ratings
     *
     * @return \AppYandexSdk\Model\QualityRatingDTO[]
     */
     ...
     * Sets ratings
     *
     * @param  \AppYandexSdk\Model\QualityRatingDTO[]  $ratings  Список значений индекса качества.
     * @return self
     */
