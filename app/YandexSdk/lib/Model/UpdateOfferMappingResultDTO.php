 ...
 */
class UpdateOfferMappingResultDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'errors' => '\AppYandexSdk\Model\OfferMappingErrorDTO[]',
        'warnings' => '\AppYandexSdk\Model\OfferMappingErrorDTO[]',
    ];
     ...
     * Gets errors
     *
     * @return \AppYandexSdk\Model\OfferMappingErrorDTO[]|null
     */
     ...
     * Sets errors
     *
     * @param  \AppYandexSdk\Model\OfferMappingErrorDTO[]|null  $errors  Ошибки.  Если хотя бы по одному товару есть ошибка, информация в каталоге не обновится по всем переданным товарам.
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param  \AppYandexSdk\Model\OfferMappingErrorDTO[]|null  $warnings  Предупреждения.  Информация в каталоге обновится.
     * @return self
     */
