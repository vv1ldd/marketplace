 ...
 */
class OrderItemDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        ...
        'promos' => '\AppYandexSdk\Model\OrderItemPromoDTO[]',
        'instances' => '\AppYandexSdk\Model\OrderItemInstanceDTO[]',
        'details' => '\AppYandexSdk\Model\OrderItemDetailDTO[]',
        'subsidies' => '\AppYandexSdk\Model\OrderItemSubsidyDTO[]',
     ...
     * Gets promos
     *
     * @return \AppYandexSdk\Model\OrderItemPromoDTO[]|null
     */
     ...
     * Sets promos
     *
     * @param  \AppYandexSdk\Model\OrderItemPromoDTO[]|null  $promos  Информация о вознаграждении продавцу за скидки на товар по промокодам, купонам и акциям.
     * @return self
     */
     ...
     * Gets details
     *
     * @return \AppYandexSdk\Model\OrderItemDetailDTO[]|null
     *
     * @deprecated
     */
     ...
     * Sets details
     *
     * @param  \AppYandexSdk\Model\OrderItemDetailDTO[]|null  $details  {% note warning \"Для получения информации о невыкупах и возвратах используйте [GET v2/campaigns/{campaignId}/returns](../../reference/orders/getReturns.md).\" %}     {% endnote %}  Информация о невыкупленных или возвращенных товарах в заказе.
     * @return self
     *
     * @deprecated
     */
     ...
     * Gets subsidies
     *
     * @return \AppYandexSdk\Model\OrderItemSubsidyDTO[]|null
     */
     ...
     * Sets subsidies
     *
     * @param  \AppYandexSdk\Model\OrderItemSubsidyDTO[]|null  $subsidies  Список субсидий по типам.
     * @return self
     */
