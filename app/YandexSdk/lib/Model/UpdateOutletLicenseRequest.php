 ...
 */
class UpdateOutletLicenseRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'licenses' => '\AppYandexSdk\Model\OutletLicenseDTO[]',
    ];
     ...
     * Gets licenses
     *
     * @return \AppYandexSdk\Model\OutletLicenseDTO[]
     */
     ...
     * Sets licenses
     *
     * @param  \AppYandexSdk\Model\OutletLicenseDTO[]  $licenses  Список лицензий. Обязательный параметр, должен содержать информацию хотя бы об одной лицензии.
     * @return self
     */
