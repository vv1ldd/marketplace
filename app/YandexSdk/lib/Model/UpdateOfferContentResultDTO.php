 ...
 */
class UpdateOfferContentResultDTO implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'errors' => '\AppYandexSdk\Model\OfferContentErrorDTO[]',
        'warnings' => '\AppYandexSdk\Model\OfferContentErrorDTO[]',
    ];
     ...
     * Gets errors
     *
     * @return \AppYandexSdk\Model\OfferContentErrorDTO[]|null
     */
     ...
     * Sets errors
     *
     * @param  \AppYandexSdk\Model\OfferContentErrorDTO[]|null  $errors  Ошибки.  Если хотя бы по одному товару есть ошибка, информация в каталоге не обновится по всем переданным товарам.
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param  \AppYandexSdk\Model\OfferContentErrorDTO[]|null  $warnings  Предупреждения.  Информация в каталоге обновится.
     * @return self
     */
