...
class OrderBusinessInformationApi
{
    ...
    {
        [$response] = $this->getOrderBusinessBuyerInfoWithHttpInfo($campaign_id, $order_id, $contentType);
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetBusinessBuyerInfoResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetBusinessBuyerInfoResponse';
        $request = $this->getOrderBusinessBuyerInfoRequest($campaign_id, $order_id, $contentType);
     ...
     * @return \AppYandexSdk\Model\GetBusinessDocumentsInfoResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->getOrderBusinessDocumentsInfoWithHttpInfo($campaign_id, $order_id, $contentType);
     ...
     * @param  int  $order_id  Идентификатор заказа. (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['getOrderBusinessDocumentsInfo'] to see the possible values for this operation
     * @return array of \AppYandexSdk\Model\GetBusinessDocumentsInfoResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function getOrderBusinessDocumentsInfoWithHttpInfo($campaign_id, $order_id, string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetBusinessDocumentsInfoResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetBusinessDocumentsInfoResponse';
        $request = $this->getOrderBusinessDocumentsInfoRequest($campaign_id, $order_id, $contentType);
