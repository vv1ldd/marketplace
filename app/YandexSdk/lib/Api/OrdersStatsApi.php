...
class OrdersStatsApi
{
     ...
     * @param  \AppYandexSdk\Model\GetOrdersStatsRequest|null $get_orders_stats_request get_orders_stats_request (optional)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOrdersStatsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOrdersStatsResponse';
        $request = $this->getOrdersStatsRequest($campaign_id, $page_token, $limit, $get_orders_stats_request, $contentType);
