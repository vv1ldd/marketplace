...
class BusinessesApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetBusinessSettingsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetBusinessSettingsResponse';
        $request = $this->getBusinessSettingsRequest($business_id, $contentType);
