...
class TariffsApi
{
     ...
     *
     * @param  \AppYandexSdk\Model\CalculateTariffsRequest $calculate_tariffs_request calculate_tariffs_request (required)
     ...
     * Калькулятор стоимости услуг
     *
     * @param  \AppYandexSdk\Model\CalculateTariffsRequest $calculate_tariffs_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calculateTariffs'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\CalculateTariffsResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\CalculateTariffsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\CalculateTariffsResponse';
        $request = $this->calculateTariffsRequest($calculate_tariffs_request, $contentType);
