...
class OutletsApi
{
     ...
     * @param  \AppYandexSdk\Model\ChangeOutletRequest $change_outlet_request change_outlet_request (required)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\CreateOutletResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\CreateOutletResponse';
        $request = $this->createOutletRequest($campaign_id, $change_outlet_request, $contentType);
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOutletResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOutletResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOutletWithHttpInfo($campaign_id, $outlet_id, string $contentType = self::contentTypes['getOutlet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOutletResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOutletResponse';
        $request = $this->getOutletRequest($campaign_id, $outlet_id, $contentType);
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOutletsResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOutletsResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOutletsWithHttpInfo($campaign_id, $page_token = null, $limit = 25, $region_id = null, $shop_outlet_code = null, $region_id2 = null, string $contentType = self::contentTypes['getOutlets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOutletsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOutletsResponse';
        $request = $this->getOutletsRequest($campaign_id, $page_token, $limit, $region_id, $shop_outlet_code, $region_id2, $contentType);
