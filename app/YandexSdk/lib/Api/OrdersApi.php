...
class OrdersApi
{
     ...
     * @param  \AppYandexSdk\Model\AcceptOrderCancellationRequest $accept_order_cancellation_request accept_order_cancellation_request (required)
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\AcceptOrderCancellationRequest $accept_order_cancellation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['acceptOrderCancellation'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\CreateOrderRequest $create_order_request create_order_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\CreateOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\CreateOrderRequest $create_order_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createOrder'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\CreateOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderWithHttpInfo($campaign_id, $create_order_request, string $contentType = self::contentTypes['createOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\CreateOrderResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\CreateOrderResponse';
        $request = $this->createOrderRequest($campaign_id, $create_order_request, $contentType);
     ...
     * @param  \AppYandexSdk\Model\GetBusinessOrdersRequest $get_business_orders_request Параметры фильтрации заказов. (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetBusinessOrdersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetBusinessOrdersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBusinessOrdersWithHttpInfo($business_id, $get_business_orders_request, $page_token = null, $limit = 50, string $contentType = self::contentTypes['getBusinessOrders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetBusinessOrdersResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetBusinessOrdersResponse';
        $request = $this->getBusinessOrdersRequest($business_id, $get_business_orders_request, $page_token, $limit, $contentType);
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     * @deprecated
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getOrderWithHttpInfo($campaign_id, $order_id, string $contentType = self::contentTypes['getOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOrderResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOrderResponse';
        $request = $this->getOrderRequest($campaign_id, $order_id, $contentType);
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOrderIdentifiersStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOrderIdentifiersStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderIdentifiersStatusWithHttpInfo($campaign_id, $order_id, string $contentType = self::contentTypes['getOrderIdentifiersStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOrderIdentifiersStatusResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOrderIdentifiersStatusResponse';
        $request = $this->getOrderIdentifiersStatusRequest($campaign_id, $order_id, $contentType);
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\GetOrderUpdateOptionsRequest $get_order_update_options_request get_order_update_options_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOrderUpdateOptionsResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\GetOrderUpdateOptionsRequest $get_order_update_options_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrderUpdateOptions'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOrderUpdateOptionsResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUpdateOptionsWithHttpInfo($campaign_id, $get_order_update_options_request, string $contentType = self::contentTypes['getOrderUpdateOptions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOrderUpdateOptionsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOrderUpdateOptionsResponse';
        $request = $this->getOrderUpdateOptionsRequest($campaign_id, $get_order_update_options_request, $contentType);
     ...
     * @param  \AppYandexSdk\Model\OrderDeliveryDispatchType|null $dispatch_type Способ отгрузки (optional)
     ...
     * @param  \AppYandexSdk\Model\OrderBuyerType|null $buyer_type Фильтрация заказов по типу покупателя. (optional)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetOrdersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     * @deprecated
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetOrdersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getOrdersWithHttpInfo($campaign_id, $order_ids = null, $status = null, $substatus = null, $from_date = null, $to_date = null, $supplier_shipment_date_from = null, $supplier_shipment_date_to = null, $updated_at_from = null, $updated_at_to = null, $dispatch_type = null, $fake = false, $has_cis = false, $only_waiting_for_cancellation_approve = false, $only_estimated_delivery = false, $buyer_type = null, $page = 1, $page_size = null, $page_token = null, $limit = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetOrdersResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetOrdersResponse';
        $request = $this->getOrdersRequest($campaign_id, $order_ids, $status, $substatus, $from_date, $to_date, $supplier_shipment_date_from, $supplier_shipment_date_to, $updated_at_from, $updated_at_to, $dispatch_type, $fake, $has_cis, $only_waiting_for_cancellation_approve, $only_estimated_delivery, $buyer_type, $page, $page_size, $page_token, $limit, $contentType);
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\ProvideOrderDigitalCodesRequest $provide_order_digital_codes_request provide_order_digital_codes_request (required)
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\ProvideOrderDigitalCodesRequest $provide_order_digital_codes_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['provideOrderDigitalCodes'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\ProvideOrderItemIdentifiersRequest $provide_order_item_identifiers_request provide_order_item_identifiers_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\ProvideOrderItemIdentifiersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\ProvideOrderItemIdentifiersRequest $provide_order_item_identifiers_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['provideOrderItemIdentifiers'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\ProvideOrderItemIdentifiersResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function provideOrderItemIdentifiersWithHttpInfo($campaign_id, $order_id, $provide_order_item_identifiers_request, string $contentType = self::contentTypes['provideOrderItemIdentifiers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\ProvideOrderItemIdentifiersResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\ProvideOrderItemIdentifiersResponse';
        $request = $this->provideOrderItemIdentifiersRequest($campaign_id, $order_id, $provide_order_item_identifiers_request, $contentType);
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\SetOrderBoxLayoutRequest $set_order_box_layout_request set_order_box_layout_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\SetOrderBoxLayoutResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\SetOrderBoxLayoutRequest $set_order_box_layout_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setOrderBoxLayout'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\SetOrderBoxLayoutResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setOrderBoxLayoutWithHttpInfo($campaign_id, $order_id, $set_order_box_layout_request, string $contentType = self::contentTypes['setOrderBoxLayout'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\SetOrderBoxLayoutResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\SetOrderBoxLayoutResponse';
        $request = $this->setOrderBoxLayoutRequest($campaign_id, $order_id, $set_order_box_layout_request, $contentType);
     ...
     * @param  \AppYandexSdk\Model\SetOrderShipmentBoxesRequest $set_order_shipment_boxes_request set_order_shipment_boxes_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\SetOrderShipmentBoxesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     * @deprecated
     */
     ...
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  int $shipment_id { % note warning \&quot;Параметр больше не используется\&quot; % }  Передайте любое число, чтобы получился корректный URL.  { % endnote % }  Идентификатор грузового места. (required)
     * @param  \AppYandexSdk\Model\SetOrderShipmentBoxesRequest $set_order_shipment_boxes_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setOrderShipmentBoxes'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\SetOrderShipmentBoxesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function setOrderShipmentBoxesWithHttpInfo($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request, string $contentType = self::contentTypes['setOrderShipmentBoxes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\SetOrderShipmentBoxesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\SetOrderShipmentBoxesResponse';
        $request = $this->setOrderShipmentBoxesRequest($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request, $contentType);
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateExternalOrderIdRequest $update_external_order_id_request update_external_order_id_request (required)
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateExternalOrderIdRequest $update_external_order_id_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateExternalOrderId'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderRequest $update_order_request update_order_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\UpdateOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderRequest $update_order_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrder'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\UpdateOrderResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderWithHttpInfo($campaign_id, $update_order_request, string $contentType = self::contentTypes['updateOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\UpdateOrderResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\UpdateOrderResponse';
        $request = $this->updateOrderRequest($campaign_id, $update_order_request, $contentType);
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderItemRequest $update_order_item_request update_order_item_request (required)
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderItemRequest $update_order_item_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrderItems'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderStatusRequest $update_order_status_request update_order_status_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\UpdateOrderStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderStatusRequest $update_order_status_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrderStatus'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\UpdateOrderStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderStatusWithHttpInfo($campaign_id, $order_id, $update_order_status_request, string $contentType = self::contentTypes['updateOrderStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\UpdateOrderStatusResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\UpdateOrderStatusResponse';
        $request = $this->updateOrderStatusRequest($campaign_id, $order_id, $update_order_status_request, $contentType);
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderStatusesRequest $update_order_statuses_request update_order_statuses_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\UpdateOrderStatusesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\UpdateOrderStatusesRequest $update_order_statuses_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrderStatuses'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\UpdateOrderStatusesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderStatusesWithHttpInfo($campaign_id, $update_order_statuses_request, string $contentType = self::contentTypes['updateOrderStatuses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\UpdateOrderStatusesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\UpdateOrderStatusesResponse';
        $request = $this->updateOrderStatusesRequest($campaign_id, $update_order_statuses_request, $contentType);
