...
class WarehousesApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetFulfillmentWarehousesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetFulfillmentWarehousesResponse';
        $request = $this->getFulfillmentWarehousesRequest($campaign_id, $contentType);
     ...
     * @param  \AppYandexSdk\Model\GetPagedWarehousesRequest|null $get_paged_warehouses_request get_paged_warehouses_request (optional)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetPagedWarehousesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     * @param  string|null $page_token Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Передавайте значение выходного параметра &#x60;nextPageToken&#x60;, полученное при последнем запросе. (optional)
     * @param  int|null $limit {{ limit-param-description }} (optional, default to 15)
     * @param  \AppYandexSdk\Model\GetPagedWarehousesRequest|null $get_paged_warehouses_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPagedWarehouses'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetPagedWarehousesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPagedWarehousesWithHttpInfo($business_id, $page_token = null, $limit = 15, $get_paged_warehouses_request = null, string $contentType = self::contentTypes['getPagedWarehouses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetPagedWarehousesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetPagedWarehousesResponse';
        $request = $this->getPagedWarehousesRequest($business_id, $page_token, $limit, $get_paged_warehouses_request, $contentType);
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\GetWarehousesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     * @deprecated
     */
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\GetWarehousesResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiNotFoundErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getWarehousesWithHttpInfo($business_id, string $contentType = self::contentTypes['getWarehouses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\GetWarehousesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\GetWarehousesResponse';
        $request = $this->getWarehousesRequest($business_id, $contentType);
     ...
     * @param  \AppYandexSdk\Model\UpdateWarehouseStatusRequest $update_warehouse_status_request update_warehouse_status_request (required)
     ...
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AppYandexSdk\Model\UpdateWarehouseStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse
     */
     ...
     *
     * @param  int $campaign_id Идентификатор кампании (магазина) — технический идентификатор, который представляет ваш магазин в системе Яндекс Маркета при работе через API. Он однозначно связывается с вашим магазином, но предназначен только для автоматизированного взаимодействия.  Его можно узнать с помощью запроса [GET v2/campaigns](../../reference/campaigns/getCampaigns.md) или найти в кабинете продавца на Маркете. Нажмите на иконку вашего аккаунта → **Настройки** и в меню слева выберите **API и модули**:  * блок **Идентификатор кампании**; * вкладка **Лог запросов** → выпадающий список в блоке **Показывать логи**.  ⚠️ Не путайте его с: - идентификатором магазина, который отображается в личном кабинете продавца; - рекламными кампаниями. (required)
     * @param  \AppYandexSdk\Model\UpdateWarehouseStatusRequest $update_warehouse_status_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWarehouseStatus'] to see the possible values for this operation
     *
     * @throws \AppYandexSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AppYandexSdk\Model\UpdateWarehouseStatusResponse|\AppYandexSdk\Model\ApiClientDataErrorResponse|\AppYandexSdk\Model\ApiUnauthorizedErrorResponse|\AppYandexSdk\Model\ApiForbiddenErrorResponse|\AppYandexSdk\Model\ApiLimitErrorResponse|\AppYandexSdk\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWarehouseStatusWithHttpInfo($campaign_id, $update_warehouse_status_request, string $contentType = self::contentTypes['updateWarehouseStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\AppYandexSdk\Model\UpdateWarehouseStatusResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\AppYandexSdk\Model\UpdateWarehouseStatusResponse';
        $request = $this->updateWarehouseStatusRequest($campaign_id, $update_warehouse_status_request, $contentType);
