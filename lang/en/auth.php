...
return [
    ...
    'simple_l1' => [
        ...
        'inline' => [
            ...
            'body' => 'Approve in Meanly One, then return to Meanly.',
            'cta' => 'Continue now',
        ...
        'vault_open' => [
            ...
            'body' => 'Meanly One will open now. Approve your Vault, and we will bring you back to your purchase safe.',
            'facts' => [
        ...
        'identity_create' => [
            ...
            'body' => 'Meanly One will open now. Create or confirm your Meanly account there, then return to Meanly.',
            'facts' => [
        ...
        'identity_confirm' => [
            ...
            'body' => 'Meanly One will open now. Approve your account, then return to Meanly.',
            'facts' => [
                'no_password' => 'No password needed.',
                'passkey_device' => 'Meanly receives only a verified account result.',
            ],
