...
return [
    ...
    'digits'               => 'Недопустимый формат',
    'digits_between'       => 'Количество символов должно быть от :min до :max.',
    'dimensions'           => 'Изображение, указанное, имеет недопустимые размеры.',
    ...
    'gt'                   => [
        ...
        'file'    => 'Размер файла, указанный, должен быть больше :value Кб.',
    ...
    'gte'                  => [
        ...
        'file'    => 'Размер файла, указанный, должен быть :value Кб или больше.',
    ...
    'image'                => 'Файл, указанный, должен быть изображением.',
    ...
    'lt'                   => [
        ...
        'file'    => 'Размер файла, указанный, должен быть меньше :value Кб.',
    ...
    'lte'                  => [
        ...
        'file'    => 'Размер файла, указанный, должен быть :value Кб или меньше.',
    ...
    'mimes'                => 'Файл, указанный, должен быть одного из следующих типов: :values.',
    'mimetypes'            => 'Файл, указанный, должен быть одного из следующих типов: :values.',
    'min'                  => [
        'array'   => 'Количество элементов должно быть не меньше :min.',
        'file'    => 'Размер файла, указанный, должен быть не меньше :min Кб.',
        'numeric' => 'Значение поля :attribute должно быть не меньше :min.',
        'string'  => 'Проверьте длинну.',
    ],
    ...
    'size'                 => [
        ...
        'file'    => 'Размер файла, указанный, должен быть равен :size Кб.',
    ...
    'throttle'             => 'Слишком много попыток. Пожалуйста, попробуйте ещё раз через :seconds секунд.',
];
