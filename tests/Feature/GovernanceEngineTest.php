...
class GovernanceEngineTest extends TestCase
{
    ...
    public function test_super_admin_can_approve_semantic_recommendations(): void
    {
        $admin = $this->userWithRole('super_admin', 'a');
    ...
    public function test_auditor_cannot_approve_decision_console_recommendations(): void
    {
        $auditor = $this->userWithRole('auditor', 'b');
        ...
        $this->assertSame('ROLE_REQUIRED: super_admin', $decision->reason);
    }

    public function test_partner_can_approve_supply_actions_but_not_add_product(): void
    {
        $partner = $this->userWithRole('b2b_partner', 'c');
        ...
        $this->assertSame('ROLE_REQUIRED: super_admin', $productDecision->reason);
    }

    public function test_applied_recommendation_cannot_transition_back(): void
    {
        $admin = $this->userWithRole('super_admin', 'd');
    ...
    {
        $admin = $this->userWithRole('super_admin', 'e');
